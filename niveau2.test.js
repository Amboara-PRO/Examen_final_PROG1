...
describe("Compte le nombre maximum de bobsleigh", function () {
    ...
    it("Doit retourner 2, si l'entrée contient DEUX 4 points successifs ", function () {
        expect(countMaxBobsleigh(5,["....X", "....", "X....", "X...X", "..X.."]).to.equal(2));
      });
      ...
      it("Doit retourner 2, si N=8 et une ligne ne contient pas d'arbres ", function () {
        expect(countMaxBobsleigh(8,[".X.X.X.X", "........", "X..X.X.", "X.X.X..X", "..X..XXX","XXXXXXXX"]).to.equal(3));
      });

      it("Doit retourner 0, si les lignes ne contiennent que des arbres", function () {
        expect(countMaxBobsleigh(5,["XXXXX", "XXXXX", "XXXXX", "XXXXX", "XXXXX"]).to.equal(3));
      });
  });
